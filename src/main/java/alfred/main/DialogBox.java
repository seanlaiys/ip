...
public class DialogBox extends HBox {
    ...
    /**
     * Instantiates a new DialogBox.
     *
     * @param text text to appear in DialogBox
     * @param img image to appear in DialogBox
     */
    ...
    /**
     * Returns new DialogBox for Alfred.
     *
     * @param text Alfred's input
